...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        thumbPageNameFancybox:
            backPageNameValues.map[json["thumb_page_name_fancybox"]],
        thumbPageName: backPageNameValues.map[json["thumb_page_name"]],
        ...
        seoUrl: json["seo_url"],
        config: Config.fromJson(json["config"]), yearbookCategorySortOrder: {},
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "thumb_page_name_fancybox":
            backPageNameValues.reverse[thumbPageNameFancybox],
        "thumb_page_name": backPageNameValues.reverse[thumbPageName],
        "category": category,
