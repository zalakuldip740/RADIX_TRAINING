...
import 'package:retrofitdemo2/Cubit/picsy_cubit.dart';
import 'package:retrofitdemo2/Data/Services/api_call.dart';
import 'package:retrofitdemo2/Data/repository.dart';
import 'package:retrofitdemo2/Screens/AlbumPage.dart';

import 'Data/Model/modeldata.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: BlocProvider(
        create: (context) => PicsyCubit(Repository(apiservice)),
        child: Scaffold(
          backgroundColor: Colors.white,
          body: Center(
            child: BlocBuilder<PicsyCubit, PicsyState>(
