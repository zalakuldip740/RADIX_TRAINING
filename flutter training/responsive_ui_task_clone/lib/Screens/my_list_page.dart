...
import 'package:responsive_ui_task_clone/Screens/my_list_description.dart';
import 'package:responsive_ui_task_clone/Widgets/ListPageAppbar.dart';
            ...
            Expanded(
              child: Row(
                children: [
                  ...
                  if (!Responsive.isMobile(context))
                    Expanded(
                        flex: 3, child: ListDecsription(itemdesc: defaultvalue))
                ],
              ),
            ),
          ],
